...
class MusicPlayerService : Service() {
    ...
    private fun sendNotification(track: Track) {
        ...
        val notification =
            NotificationCompat.Builder(this, CHANNEL_ID).setStyle(style).setContentTitle(track.name)
                .setContentText(track.desc)
                .addAction(R.drawable.ic_prev, "prev", createPrevPendingIntent()).addAction(
